    <?php 
        ...
        // $test = $component_parent->testDEQUY_2($id_Component_parent);
        // foreach($component_parent->testDEQUY_2_8T4($id_Component_parent) as $row){
        //     print_r($row); 
        //     echo '<br>';
        // }
    ?>
    <div class="map" style="display:none;" >
        <div id="tree-container" style="max-width: 90%; padding: 20px; overflow-x: auto; overflow-y: auto; "></div>
        <div class="map_control_btn">

            <div class="main_btn">
                <div class="hertical">
                    <button id="move_up_treeMap"><i class="fa-solid fa-caret-up"></i></button>
                    <button id="move_down_treeMap"><i class="fa-solid fa-caret-down"></i></button>
                </div>
                <div class="vertical">
                    <button id="move_left_treeMap"><i class="fa-solid fa-caret-left"></i></button>
                    <button id="center_treeMap" onclick="">C</button>
                    <button id="move_right_treeMap"><i class="fa-solid fa-caret-right"></i></button>
                </div>
            </div>
            <div class="zoom_btn">
                <button id="zoom-in-button"><i class="fa-solid fa-plus"></i></button>
                <button id="zoom-out-button"><i class="fa-solid fa-minus"></i></button>
            </div>
        </div>
    </div>
    <div id="div_customContent" style="display:none;"></div>
    <input type="range" id="tree-width-input" min="500" max="4000" value="2000" step="10" style="display:none;">
                    ...
                    <div class="bodyofForm">
                        ...
                        <div class="Info_tab">
                            <div class="tab">
                                ...
                                <button type="button" class="tablinks" onclick="change_tab(event, 'detail_info')">Thông
                                    tin
                                    chi tiết</button>
                                <button type="button" class="tablinks" onclick="change_tab(event, 'tbl_dmnl')">Định mức
                                    nguyên liệu</button>
                                <button type="button" class="tablinks"
                                    onclick="change_tab(event, 'tbl_taolenhsanxuat')">Tạo
                    ...
                    <div class="tabcontent" id="tbl_dmnl">
                        <div class="bodyofForm Material" id="table_material_CT">
                            ...
                            <div class="item_CT">
                                ...
                                <input type="number" name="quantity_Component_inStorage"
    ...
    <div id="tbl_taolenhsanxuat" class="tableComponent tabcontent" style="width:90%;">
        ...
        <table id="tbl_BOM_hidden_miss_M_of_C" class="stripe hover display order-column row-border  "
        ...
        <button
            onclick="exportTableToExcel('tbl_BOM_hidden_miss_M_of_C', '<?php echo 'BOM_'.$component_parent_basicInfo['name'] ?>')">Xuất
            EXCEL</button>
        <div class="input_class">
            <form action="" method="post" id="production_cmd_form">
                ...
                <fieldset>
                    <legend>Số lượng sản xuất:</legend>
                    <input required type="number" name="quantity_production" id="">
                </fieldset>
                <fieldset>
                ...
                <button class="btn_common" style="width:auto; border-radius: 10px;" type="button"
...
var inputRange = document.getElementById("tree-width-input");

// Add event listener to dynamically update tree width
inputRange.addEventListener("input", function() {
    d3.select("#tree-container svg").remove();
    var newWidth = parseInt(this.value);
    treeMap_DMNL(<?php echo $id_Component_parent  ?>, newWidth)
});
treeMap_DMNL(<?php echo $id_Component_parent  ?>, 200)
